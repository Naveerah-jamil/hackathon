...
export default function AboutUs() {
  return (
    <div>
      {/* First Section */}
      <div className="flex flex-col sm:flex-row justify-between mt-[50px] px-4 sm:px-8">
        {/* Left Block */}
        <div className="relative w-full sm:w-[672px] h-[478px] bg-[#007580]">
          ...
          <button className="absolute w-[179px] h-[56px] top-[368px] left-[64px] bg-blue-500 flex items-center justify-center pt-[16px] px-[32px] mt-4 sm:mt-0">
        ...
        {/* Image */}
        <div className="relative w-full sm:w-[619px] h-[478px] mt-8 sm:mt-0">
          <Image
